...
| Homebrew on Linux | x86_64, ARM64 | [Homebrew prerequisites](docs/distribution.md#homebrew-on-linux), then `brew install hashimkarim/tap/android-agent-lab` |
